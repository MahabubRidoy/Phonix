...
<script type="text/javascript">
      	...
      	function cat(){
      		...
      		document.formcalc.textres.value=" 200 gm ";
      		}else if (num1>401 && num1<=500) {
      		document.formcalc.textres.value=" 300 gm ";
      		}else if (num1>501 && num1<=600) {
      		document.formcalc.textres.value=" 350 gm ";
      		}else if (num1>601 && num1<=900) {
      		document.formcalc.textres.value=" 500 gm ";
      		}else if (num1>901 && num1<=1300) {
      		document.formcalc.textres.value=" 550 gm ";
      		}else if (num1>1301 && num1<=1500) {
      		document.formcalc.textres.value=" 600 gm ";
      		}else if (num1>1501 && num1<=2000) {
      		document.formcalc.textres.value=" 750 gm ";
      		}else if (num1>2001 && num1<=2500) {
      		document.formcalc.textres.value=" 800 gm ";
      		}else if (num1>2501 && num1<=3000) {
      			...
      			<div align="center" style="border: 1px solid white" >       			
      				<h3>Cat</h3>
      					<img src="images/cat.jpg" class="img-responsive" alt="cat" />
      						<p>Please Enter Your Cats Weight (gm only) </p>
      							<form name="formcalc">
      							<input type="text" name="txtnum1"> </br></br>
      							<input type="button" value="See Nutrition" onclick="cat()"></br></br>
