...
<script type="text/javascript">
      	...
      	function dog(){
      		...
      		if (num1>0 && num1<=3) {
      		document.formcalc.textres.value=" 3000 gm ";	
    	  	} else if (num1>4 && num1<=8) {
      		document.formcalc.textres.value=" 4000 gm ";
      		}else if (num1>9 && num1<=10) {
      		document.formcalc.textres.value=" 5000 gm ";
      		}else if (num1>11 && num1<=16) {
      		document.formcalc.textres.value=" 6000 gm ";
      		}else if (num1>17 && num1<=20) {
      		document.formcalc.textres.value=" 7000 gm ";
      		}else if (num1>52) {
...
<div class="jumbotron text-center">
  <h1>SEE YOUR DOGS INFORMATION</h1>
  <p>Please input your Dogs Age to see Nutrition</p> 
</div>
  ...
  <div class="row">
    ...
    <div class="col-sm-4"> 
      			<div align="center" style="border: 1px solid white" >       			
      				<h3>Dog</h3>
      					<img src="images/dog.jpg" class="img-responsive" alt="Dog" />
      						<p>Please Enter Your Dog Age (year) </p>
      							<form name="formcalc">
      							<input type="text" name="txtnum1"> </br></br>
      							<input type="button" value="Suggested Feeding Amount" onclick="dog()"></br></br>
